...
SELECT SNAME FROM STUDENT WHERE SPI > 6.5
...
SELECT SNAME,BRANCH FROM STUDENT WHERE SPI>8 AND STDID < 105
...
SELECT *FROM STUDENT WHERE STDID < 105 OR STDID > 109
...
SELECT *FROM STUDENT WHERE (SPI > 7 OR SPI <=9) AND (STDID <102 OR STDID > 108)
...
SELECT *FROM STUDENT WHERE (BRANCH='CIVIL' OR BRANCH='MECHANICAL') AND SPI>8